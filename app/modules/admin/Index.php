...
class Index extends Controller {
  ...
  static function holiday(): string {
    ...
    $holiday = [
      ...
      '2026-05-01'=> ['holiday'=>true, 'name'=>'劳动节', 'img'=>$url.'20260501.png', 'bg'=>$url.'202605.png'],
      '2026-05-02'=> ['holiday'=>true, 'name'=>'劳动节', 'img'=>$url.'20260502.png', 'bg'=>$url.'202605.png'],
      '2026-05-03'=> ['holiday'=>true, 'name'=>'劳动节', 'img'=>$url.'20260503.png', 'bg'=>$url.'202605.png'],
      '2026-05-04'=> ['holiday'=>true, 'name'=>'劳动节', 'img'=>$url.'20260504.png', 'bg'=>$url.'202605.png'],
      '2026-05-05'=> ['holiday'=>true, 'name'=>'劳动节', 'img'=>$url.'20260505.png', 'bg'=>$url.'202605.png'],
