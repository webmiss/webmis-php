...
use Library\Export;
use Util\Util;
use Model\ErpBaseOrganization as ErpBaseOrganizationM;

class ErpBaseOrganization extends Base {
  ...
  static function Export() {
    ...
    // 导出文件
    $admin = AdminToken::Token($token);
    self::$export_filename = 'ErpBaseOrganization_'.date('YmdHis').'_'.$admin->uid.'.xlsx';
